...
диагнозам потерь металла в исследуемом материале (отвальные хвосты, концентрат,
промпродукт — материал указан в отчёте) предложить КОНКРЕТНЫЕ, проверяемые в
лаборатории гипотезы по снижению потерь.
...
8. Гипотезы формулируй уместно исследуемому материалу из отчёта: для хвостов —
   снижение потерь; для концентрата — снижение потерь металла при сохранении
   качества концентрата; для промпродукта/песков/слива — доводка и правильное
   распределение потоков; для питания — предотвращение будущих потерь.
