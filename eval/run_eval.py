...
ВМЕШАТЕЛЬСТВОМ (same intervention: тот же агрегат/параметр/приём), даже если формулировка
и обоснование другие. Смежные, но разные вмешательства (например «футеровка» и «шаровая
загрузка») покрытием НЕ считаются.
